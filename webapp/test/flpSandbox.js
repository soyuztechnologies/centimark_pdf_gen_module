		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#centipdfgeneratorpdfgenerator-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"centipdfgeneratorpdfgenerator-display": {
								"semanticObject": "centipdfgeneratorpdfgenerator",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=centi.pdf.generator.pdfgenerator",
									"url": sap.ui.require.toUrl("centi/pdf/generator/pdfgenerator")
								}
							}
						}
					}
